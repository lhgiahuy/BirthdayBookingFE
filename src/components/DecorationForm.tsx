...
import { Card, CardContent, CardMedia, FormGroup, Grid, IconButton, TextField, Typography } from "@mui/material";
            ...
            <Grid>
                <Grid container className="mt-6">
                    ...
                    <Grid item xs={12} className='flex justify-between items-center'>
                        <Typography variant='h4' sx={{ ml: 1.25 }}>Choose your decorations</Typography>
                    </Grid>
                                                    ...
                                                    <CardContent sx={{ flex: '1 0 auto' }}>
                                                        ...
                                                        <Grid item xs={10}>
                                                            <Typography variant="subtitle1" component="div">
                                                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quae nihil quidem quisquam iure placeat harum iusto, ipsa culpa repudiandae perferendis rem rerum magnam, dolor qui consectetur, eos provident autem natus!
                                                            </Typography>
                                                        </Grid>
                                                    </CardContent>
